"""W1-P02 GitHub PostgreSQL knowledge retention runtime helper (v503-pattern contract).
...
EXPECTED_PORT = 5432
EXPECTED_DATABASE = "sedi_w1p02_knowledge"
EXPECTED_USER = "sedi_w1p02_test"
EXPECTED_PASSWORD = "sedi_w1p02_test_password"
EXPECTED_TEST_URL = (
...
W1P02_EXPECTED_SCHEMA_TABLES: tuple[str, ...] = (
    "i5_raw_evidence",
    "knowledge_units",
...
W1P02_RUNTIME_SELECTORS: tuple[str, ...] = (
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T5_01_metadata_contains_ku_tables',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T5_02_named_checks_present_in_pg_catalog',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T6_01_positive_raw_evidence_insert',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T6_02_positive_ku_insert_not_eligible',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T6_03_positive_provenance_attach_eligible',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T6_04_positive_gap_target_ku_fk',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T8_uq_fk_runtime_negative',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T9_01_service_eligibility_evaluation',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T9_02_raw_retention_mode_insertable',
)

W1P02_EXPECTED_RUNTIME_NODE_IDS: frozenset[str] = frozenset(
    (
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T5_01_metadata_contains_ku_tables',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T5_02_named_checks_present_in_pg_catalog',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T6_01_positive_raw_evidence_insert',
    ...
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T6_03_positive_provenance_attach_eligible',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T6_04_positive_gap_target_ku_fk',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ire_retention_mode_vocab]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ire_content_hash_format]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ire_prohibited_requires_excluded_mode]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ire_storage_mode_vocab]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ire_byte_hash_format]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ire_hash_algorithm_constant]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ire_canonical_url_nonempty]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ku_knowledge_type_vocab]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ku_canonical_hash_format]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ku_eligible_requires_provenance]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ku_runtime_eligibility_vocab]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ku_deduplication_key_format]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ku_hash_algorithm_constant]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ku_canonicalization_version_constant]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ku_normalized_statement_nonempty]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ku_evidence_strength_vocab]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ku_publication_state_vocab]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_ku_medical_safety_state_vocab]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_kp_retrieval_method_nonempty]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T7_negative_check_constraints[W1P02-T7-ck_kp_content_hash_format]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T8_uq_fk_runtime_negative[W1P02-T8-uq_ku_deduplication_key]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T8_uq_fk_runtime_negative[W1P02-T8-uq_kp_knowledge_unit_id]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T8_uq_fk_runtime_negative[W1P02-T8-uq_ku_canonical_version]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T8_uq_fk_runtime_negative[W1P02-T8-fk_kp_knowledge_unit_id]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T8_uq_fk_runtime_negative[W1P02-T8-fk_kp_source_profile_id]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T8_uq_fk_runtime_negative[W1P02-T8-fk_ire_source_profile_id]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T8_uq_fk_runtime_negative[W1P02-T8-fk_kp_raw_evidence_id]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T8_uq_fk_runtime_negative[W1P02-T8-fk_knowledge_gaps_target_knowledge_unit_id]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T9_01_service_eligibility_evaluation',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T9_02_raw_retention_mode_insertable[W1P02-T9-RAW_FULL_GOVERNED_RETENTION]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T9_02_raw_retention_mode_insertable[W1P02-T9-RAW_TRANSIENT_PROCESSING]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T9_02_raw_retention_mode_insertable[W1P02-T9-RAW_MINIMAL_EVIDENCE_ONLY]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T9_02_raw_retention_mode_insertable[W1P02-T9-RAW_LINK_AND_CITATION_ONLY]',
    'backend/tests/test_section30_i5_w1_p02_ku_provenance.py::test_W1P02_T9_02_raw_retention_mode_insertable[W1P02-T9-RAW_EXCLUDED_PROTECTED_ELEMENTS]',
    )
)
...
@dataclass
class W1P02GitHubPostgresEvidence:
    mode: str = ""
    run_id: str = ""
    workflow_sha: str = ""
    commit_sha: str = ""
...
class W1P02HarnessError(RuntimeError):
...
def assert_no_db_bootstrap_in_collect_only(collect_only_mode: bool) -> None:
    if collect_only_mode:
        raise W1P02HarnessError(SENTINEL_RUNTIME_BOOTSTRAP_FORBIDDEN_IN_COLLECT_ONLY)


def scrub_inherited_database_env() -> None:
    for key in (
        "SEDI_W1P02_PG_ADMIN_URL",
        "SEDI_W1P02_PG_TEST_URL",
        "SEDI_W1P02_PG_OWNERSHIP_MARKER",
    ):
...
def refuse_production_shared_targets(test_url: str) -> None:
    ...
    for token in PRODUCTION_REFUSE_SUBSTRINGS:
        if token in lower:
            raise W1P02HarnessError(SENTINEL_GITHUB_POSTGRES_PRODUCTION_IDENTIFIER_REFUSED)
    parsed = urlparse(test_url)
    host = (parsed.hostname or "").lower()
    if host in {"localhost", "::1"}:
        raise W1P02HarnessError(SENTINEL_GITHUB_POSTGRES_TARGET_REFUSED)
...
def bind_github_database_environment(test_url: str) -> None:
    ...
    os.environ.setdefault("OPENAI_API_KEY", "w1p02-test-placeholder-not-used")
    _ = parsed
...
def verify_bound_environment(expected_db_name: str, expected_host: str) -> None:
    ...
    if not db_url or not test_url:
        raise W1P02HarnessError(SENTINEL_GITHUB_POSTGRES_URL_MISMATCH)
    if db_url != test_url:
        raise W1P02HarnessError(SENTINEL_GITHUB_POSTGRES_URL_MISMATCH)
...
def assert_import_guard_completed() -> None:
    if not _IMPORT_GUARD_COMPLETE:
        raise W1P02HarnessError(SENTINEL_APPLICATION_IMPORT_BEFORE_TEST_DATABASE_BINDING)
...
def verify_runtime_selector_manifest(
    ...
    expected = expected_ids or W1P02_EXPECTED_RUNTIME_NODE_IDS
    ...
    if len(collected) != EXPECTED_RUNTIME_NODE_COUNT:
        raise W1P02HarnessError(SENTINEL_RUNTIME_NODE_MANIFEST_MISMATCH)
...
def verify_w1p02_schema_tables(engine, expected_tables: tuple[str, ...]) -> None:
...
def set_active_node_id(state: W1P02PluginState, node_id: str) -> None:
    state.active_node_id = node_id


def clear_active_node_id(state: W1P02PluginState) -> None:
    state.active_node_id = None


def correlate_diagnostic_to_node(
    state: W1P02PluginState, node_id: str, diag: dict[str, Any]
) -> dict[str, Any]:
    payload = {
        "node_id": node_id,
        **diag,
...
def record_correlated_diagnostic(state: W1P02PluginState, diag: dict[str, Any]) -> None:
...
def _make_handle_error_listener(state: W1P02PluginState):
...
def register_handle_error_listener(engine, state: W1P02PluginState) -> None:
...
def remove_handle_error_listener(engine, state: W1P02PluginState) -> None:
...
def verify_sqlalchemy_version_minimum() -> None:
    ...
    try:
        ...
        major = 0
    if major < 2:
        raise W1P02HarnessError(BLOCKED_DEPENDENCY_RESOLUTION)
...
def resolve_runner_temp_dir(repo_root: Optional[Path] = None) -> Path:
    ...
    target = (Path(tempfile.gettempdir()) / "sedi_w1p02_postgres_runtime_evidence").resolve()
    target.mkdir(parents=True, exist_ok=True)
    if _path_is_inside(target, repo_root):
        raise W1P02HarnessError("FAIL_UNAUTHORIZED_REPOSITORY_MUTATION evidence path in repo")
    return target
...
def assert_evidence_path_outside_repository(path: Path, repo_root: Optional[Path] = None) -> None:
    ...
    if _path_is_inside(path.resolve(), repo_root.resolve()):
        raise W1P02HarnessError("FAIL_UNAUTHORIZED_REPOSITORY_MUTATION")
...
def capture_redacted_evidence(evidence: W1P02GitHubPostgresEvidence) -> dict[str, Any]:
    return {
        "mode": evidence.mode,
...
def initialize_evidence_context(state: W1P02PluginState, *, mode: str) -> None:
    ev = state.evidence
    ev.mode = mode
...
def configure_environment_from_urls(state: W1P02PluginState) -> str:
    ...
    state.evidence.selector_count = len(W1P02_RUNTIME_SELECTORS)
    return test_url


def runtime_bootstrap_after_manifest(state: W1P02PluginState) -> None:
    ...
    verify_w1p02_schema_tables(engine, W1P02_EXPECTED_SCHEMA_TABLES)
    state.evidence.schema_tables = [t for t in tables if t in W1P02_EXPECTED_SCHEMA_TABLES]
