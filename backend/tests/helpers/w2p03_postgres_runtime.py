"""W2-P03 GitHub PostgreSQL admin review runtime helper (v503-pattern contract).
...
EXPECTED_PORT = 5432
EXPECTED_DATABASE = "sedi_w2p03_safety"
EXPECTED_USER = "sedi_w2p03_test"
EXPECTED_PASSWORD = "sedi_w2p03_test_password"
EXPECTED_TEST_URL = (
...
W2P03_EXPECTED_SCHEMA_TABLES: tuple[str, ...] = (
    "knowledge_conflicts",
...
_W2P03_TEST = "backend/tests/test_section30_i5_w2_p03_admin_review.py"

W2P03_RUNTIME_SELECTORS: tuple[str, ...] = (
    "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T1_package_identity_and_schemas",
    "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T2_queue_transition_matrix",
    "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T3_list_and_filter_safety_queue",
    "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T4_start_and_close_with_decision",
    "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T5_fail_closed_close_without_decision",
    "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T6_illegal_queue_transition",
    "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T7_conflict_resolve_preserves_sides",
    "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T8_gap_list_and_triage",
    "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T9_authz_admin_token",
    "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T10_idempotent_start",
    "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T11_decision_fk_and_close_blocked",
    "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T12_api_list_safety_reviews",
)

W2P03_EXPECTED_RUNTIME_NODE_IDS: frozenset[str] = frozenset(
    (
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T1_package_identity_and_schemas",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T2_queue_transition_matrix",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T3_list_and_filter_safety_queue[list_open]",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T3_list_and_filter_safety_queue[filter_status]",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T3_list_and_filter_safety_queue[filter_ku]",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T4_start_and_close_with_decision",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T5_fail_closed_close_without_decision",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T6_illegal_queue_transition[open_to_closed]",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T6_illegal_queue_transition[closed_to_open]",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T6_illegal_queue_transition[in_review_to_open]",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T6_illegal_queue_transition[invalid_status]",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T7_conflict_resolve_preserves_sides",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T8_gap_list_and_triage",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T9_authz_admin_token[missing_token_env]",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T9_authz_admin_token[mismatch_token]",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T9_authz_admin_token[authorized_package]",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T10_idempotent_start",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T11_decision_fk_and_close_blocked",
        "backend/tests/test_section30_i5_w2_p03_admin_review.py::test_W2P03_T12_api_list_safety_reviews",
    )
...
@dataclass
class W2P03GitHubPostgresEvidence:
    mode: str = ""
    run_id: str = ""
    workflow_sha: str = ""
    commit_sha: str = ""
...
class W2P03HarnessError(RuntimeError):
...
def assert_no_db_bootstrap_in_collect_only(collect_only_mode: bool) -> None:
    if collect_only_mode:
        raise W2P03HarnessError(SENTINEL_RUNTIME_BOOTSTRAP_FORBIDDEN_IN_COLLECT_ONLY)


def scrub_inherited_database_env() -> None:
    for key in (
        "SEDI_W2P03_PG_ADMIN_URL",
        "SEDI_W2P03_PG_TEST_URL",
        "SEDI_W2P03_PG_OWNERSHIP_MARKER",
    ):
...
def refuse_production_shared_targets(test_url: str) -> None:
    ...
    for token in PRODUCTION_REFUSE_SUBSTRINGS:
        if token in lower:
            raise W2P03HarnessError(SENTINEL_GITHUB_POSTGRES_PRODUCTION_IDENTIFIER_REFUSED)
    parsed = urlparse(test_url)
    host = (parsed.hostname or "").lower()
    if host in {"localhost", "::1"}:
        raise W2P03HarnessError(SENTINEL_GITHUB_POSTGRES_TARGET_REFUSED)
...
def bind_github_database_environment(test_url: str) -> None:
    ...
    os.environ.setdefault("OPENAI_API_KEY", "w2p03-test-placeholder-not-used")
    _ = parsed
...
def verify_bound_environment(expected_db_name: str, expected_host: str) -> None:
    ...
    if not db_url or not test_url:
        raise W2P03HarnessError(SENTINEL_GITHUB_POSTGRES_URL_MISMATCH)
    if db_url != test_url:
        raise W2P03HarnessError(SENTINEL_GITHUB_POSTGRES_URL_MISMATCH)
...
def assert_import_guard_completed() -> None:
    if not _IMPORT_GUARD_COMPLETE:
        raise W2P03HarnessError(SENTINEL_APPLICATION_IMPORT_BEFORE_TEST_DATABASE_BINDING)
...
def verify_runtime_selector_manifest(
    ...
    expected = expected_ids or W2P03_EXPECTED_RUNTIME_NODE_IDS
    ...
    if len(collected) != EXPECTED_RUNTIME_NODE_COUNT:
        raise W2P03HarnessError(SENTINEL_RUNTIME_NODE_MANIFEST_MISMATCH)
...
def verify_w2p03_schema_tables(engine, expected_tables: tuple[str, ...]) -> None:
...
def set_active_node_id(state: W2P03PluginState, node_id: str) -> None:
    state.active_node_id = node_id


def clear_active_node_id(state: W2P03PluginState) -> None:
    state.active_node_id = None


def correlate_diagnostic_to_node(
    state: W2P03PluginState, node_id: str, diag: dict[str, Any]
) -> dict[str, Any]:
    payload = {
        "node_id": node_id,
        **diag,
...
def record_correlated_diagnostic(state: W2P03PluginState, diag: dict[str, Any]) -> None:
...
def _make_handle_error_listener(state: W2P03PluginState):
...
def register_handle_error_listener(engine, state: W2P03PluginState) -> None:
...
def remove_handle_error_listener(engine, state: W2P03PluginState) -> None:
...
def verify_sqlalchemy_version_minimum() -> None:
    ...
    try:
        ...
        major = 0
    if major < 2:
        raise W2P03HarnessError(BLOCKED_DEPENDENCY_RESOLUTION)
...
def resolve_runner_temp_dir(repo_root: Optional[Path] = None) -> Path:
    ...
    target = (Path(tempfile.gettempdir()) / "sedi_w2p03_postgres_runtime_evidence").resolve()
    target.mkdir(parents=True, exist_ok=True)
    if _path_is_inside(target, repo_root):
        raise W2P03HarnessError("FAIL_UNAUTHORIZED_REPOSITORY_MUTATION evidence path in repo")
    return target
...
def assert_evidence_path_outside_repository(path: Path, repo_root: Optional[Path] = None) -> None:
    ...
    if _path_is_inside(path.resolve(), repo_root.resolve()):
        raise W2P03HarnessError("FAIL_UNAUTHORIZED_REPOSITORY_MUTATION")
...
def capture_redacted_evidence(evidence: W2P03GitHubPostgresEvidence) -> dict[str, Any]:
    return {
        "mode": evidence.mode,
...
def initialize_evidence_context(state: W2P03PluginState, *, mode: str) -> None:
    ev = state.evidence
    ev.mode = mode
...
def configure_environment_from_urls(state: W2P03PluginState) -> str:
    ...
    state.evidence.selector_count = len(W2P03_RUNTIME_SELECTORS)
    return test_url


def runtime_bootstrap_after_manifest(state: W2P03PluginState) -> None:
    ...
    verify_w2p03_schema_tables(engine, W2P03_EXPECTED_SCHEMA_TABLES)
    state.evidence.schema_tables = [t for t in tables if t in W2P03_EXPECTED_SCHEMA_TABLES]
