...
EXPECTED_PORT = 5432
EXPECTED_DATABASE = "sedi_w2p01_memory"
EXPECTED_USER = "sedi_w2p01_test"
EXPECTED_PASSWORD = "sedi_w2p01_test_password"
EXPECTED_TEST_URL = (
...
W2P01_EXPECTED_SCHEMA_TABLES: tuple[str, ...] = (
...
_W2P01_TEST = "backend/tests/test_section30_i5_w2_p01_knowledge_memory.py"

W2P01_RUNTIME_SELECTORS: tuple[str, ...] = (
    f"{_W2P01_TEST}::test_W2P01_T5_01_metadata_contains_memory_tables",
    f"{_W2P01_TEST}::test_W2P01_T5_02_named_checks_present_in_pg_catalog",
    f"{_W2P01_TEST}::test_W2P01_T6_01_create_memory_linked_to_ku",
    f"{_W2P01_TEST}::test_W2P01_T6_02_supersede_updates_memory_and_old_ku",
    f"{_W2P01_TEST}::test_W2P01_T6_03_structured_diff_content_change",
    f"{_W2P01_TEST}::test_W2P01_T6_04_no_change_idempotent",
    f"{_W2P01_TEST}::test_W2P01_T7_negative_check_constraints",
    f"{_W2P01_TEST}::test_W2P01_T8_uq_fk_runtime_negative",
    f"{_W2P01_TEST}::test_W2P01_T9_01_retraction_not_eligible",
    f"{_W2P01_TEST}::test_W2P01_T9_02_chain_resolve_and_guards",
)

W2P01_EXPECTED_RUNTIME_NODE_IDS: frozenset[str] = frozenset(
    (
        f"{_W2P01_TEST}::test_W2P01_T5_01_metadata_contains_memory_tables",
        f"{_W2P01_TEST}::test_W2P01_T5_02_named_checks_present_in_pg_catalog",
        f"{_W2P01_TEST}::test_W2P01_T6_01_create_memory_linked_to_ku",
        ...
        f"{_W2P01_TEST}::test_W2P01_T6_03_structured_diff_content_change",
        f"{_W2P01_TEST}::test_W2P01_T6_04_no_change_idempotent",
        f"{_W2P01_TEST}::test_W2P01_T7_negative_check_constraints[W2P01-T7-ck_kmi_evidence_strength_vocab]",
        f"{_W2P01_TEST}::test_W2P01_T7_negative_check_constraints[W2P01-T7-ck_kmi_freshness_state_vocab]",
        f"{_W2P01_TEST}::test_W2P01_T7_negative_check_constraints[W2P01-T7-ck_kmi_conflict_state_vocab]",
        f"{_W2P01_TEST}::test_W2P01_T7_negative_check_constraints[W2P01-T7-ck_kmi_medical_safety_state_vocab]",
        f"{_W2P01_TEST}::test_W2P01_T7_negative_check_constraints[W2P01-T7-ck_kmi_runtime_eligibility_vocab]",
        f"{_W2P01_TEST}::test_W2P01_T7_negative_check_constraints[W2P01-T7-ck_kmi_supersession_state_vocab]",
        f"{_W2P01_TEST}::test_W2P01_T7_negative_check_constraints[W2P01-T7-ck_kmi_eligible_requires_current]",
        f"{_W2P01_TEST}::test_W2P01_T7_negative_check_constraints[W2P01-T7-ck_kmi_eligible_requires_current_update]",
        f"{_W2P01_TEST}::test_W2P01_T7_negative_check_constraints[W2P01-T7-ck_kmt_transition_kind_vocab]",
        f"{_W2P01_TEST}::test_W2P01_T7_negative_check_constraints[W2P01-T7-ck_kmt_change_kind_vocab]",
        f"{_W2P01_TEST}::test_W2P01_T7_negative_check_constraints[W2P01-T7-ck_kmt_idempotency_key_format]",
        f"{_W2P01_TEST}::test_W2P01_T7_negative_check_constraints[W2P01-T7-ck_kmt_diff_json_object]",
        f"{_W2P01_TEST}::test_W2P01_T8_uq_fk_runtime_negative[W2P01-T8-uq_kmi_memory_item_id]",
        f"{_W2P01_TEST}::test_W2P01_T8_uq_fk_runtime_negative[W2P01-T8-uq_kmi_knowledge_unit_id]",
        f"{_W2P01_TEST}::test_W2P01_T8_uq_fk_runtime_negative[W2P01-T8-fk_kmi_knowledge_unit_id]",
        f"{_W2P01_TEST}::test_W2P01_T8_uq_fk_runtime_negative[W2P01-T8-uq_kmt_idempotency_key]",
        f"{_W2P01_TEST}::test_W2P01_T8_uq_fk_runtime_negative[W2P01-T8-fk_kmt_memory_item_row_id]",
        f"{_W2P01_TEST}::test_W2P01_T8_uq_fk_runtime_negative[W2P01-T8-fk_kmt_from_knowledge_unit_id]",
        f"{_W2P01_TEST}::test_W2P01_T8_uq_fk_runtime_negative[W2P01-T8-fk_kmt_to_knowledge_unit_id]",
        f"{_W2P01_TEST}::test_W2P01_T8_uq_fk_runtime_negative[W2P01-T8-fk_kmi_knowledge_unit_id_alt]",
        f"{_W2P01_TEST}::test_W2P01_T9_01_retraction_not_eligible",
        f"{_W2P01_TEST}::test_W2P01_T9_02_chain_resolve_and_guards[W2P01-T9-self_parent]",
        f"{_W2P01_TEST}::test_W2P01_T9_02_chain_resolve_and_guards[W2P01-T9-cross_canonical]",
        f"{_W2P01_TEST}::test_W2P01_T9_02_chain_resolve_and_guards[W2P01-T9-resolve_superseded_by]",
        f"{_W2P01_TEST}::test_W2P01_T9_02_chain_resolve_and_guards[W2P01-T9-one_current_memory]",
        f"{_W2P01_TEST}::test_W2P01_T9_02_chain_resolve_and_guards[W2P01-T9-eligibility_fail_closed]",
        f"{_W2P01_TEST}::test_W2P01_T9_02_chain_resolve_and_guards[W2P01-T9-refuse_user_memory]",
        f"{_W2P01_TEST}::test_W2P01_T9_02_chain_resolve_and_guards[W2P01-T9-refuse_local_rag]",
        f"{_W2P01_TEST}::test_W2P01_T9_02_chain_resolve_and_guards[W2P01-T9-refuse_conversation]",
        f"{_W2P01_TEST}::test_W2P01_T9_02_chain_resolve_and_guards[W2P01-T9-project_and_idempotency]",
    )
)
...
@dataclass
class W2P01GitHubPostgresEvidence:
    mode: str = ""
    run_id: str = ""
    workflow_sha: str = ""
    commit_sha: str = ""
...
class W2P01HarnessError(RuntimeError):
...
def assert_no_db_bootstrap_in_collect_only(collect_only_mode: bool) -> None:
    if collect_only_mode:
        raise W2P01HarnessError(SENTINEL_RUNTIME_BOOTSTRAP_FORBIDDEN_IN_COLLECT_ONLY)


def scrub_inherited_database_env() -> None:
    for key in (
        "SEDI_W2P01_PG_ADMIN_URL",
        "SEDI_W2P01_PG_TEST_URL",
        "SEDI_W2P01_PG_OWNERSHIP_MARKER",
    ):
...
def refuse_production_shared_targets(test_url: str) -> None:
    ...
    for token in PRODUCTION_REFUSE_SUBSTRINGS:
        if token in lower:
            raise W2P01HarnessError(SENTINEL_GITHUB_POSTGRES_PRODUCTION_IDENTIFIER_REFUSED)
    parsed = urlparse(test_url)
    host = (parsed.hostname or "").lower()
    if host in {"localhost", "::1"}:
        raise W2P01HarnessError(SENTINEL_GITHUB_POSTGRES_TARGET_REFUSED)
...
def bind_github_database_environment(test_url: str) -> None:
    ...
    os.environ.setdefault("OPENAI_API_KEY", "w2p01-test-placeholder-not-used")
    _ = parsed
...
def verify_bound_environment(expected_db_name: str, expected_host: str) -> None:
    ...
    if not db_url or not test_url:
        raise W2P01HarnessError(SENTINEL_GITHUB_POSTGRES_URL_MISMATCH)
    if db_url != test_url:
        raise W2P01HarnessError(SENTINEL_GITHUB_POSTGRES_URL_MISMATCH)
...
def assert_import_guard_completed() -> None:
    if not _IMPORT_GUARD_COMPLETE:
        raise W2P01HarnessError(SENTINEL_APPLICATION_IMPORT_BEFORE_TEST_DATABASE_BINDING)
...
def verify_runtime_selector_manifest(
    ...
    expected = expected_ids or W2P01_EXPECTED_RUNTIME_NODE_IDS
    ...
    if len(collected) != EXPECTED_RUNTIME_NODE_COUNT:
        raise W2P01HarnessError(SENTINEL_RUNTIME_NODE_MANIFEST_MISMATCH)
...
def verify_w2p01_schema_tables(engine, expected_tables: tuple[str, ...]) -> None:
...
def set_active_node_id(state: W2P01PluginState, node_id: str) -> None:
    state.active_node_id = node_id


def clear_active_node_id(state: W2P01PluginState) -> None:
    state.active_node_id = None


def correlate_diagnostic_to_node(
    state: W2P01PluginState, node_id: str, diag: dict[str, Any]
) -> dict[str, Any]:
    payload = {
        "node_id": node_id,
        **diag,
...
def record_correlated_diagnostic(state: W2P01PluginState, diag: dict[str, Any]) -> None:
...
def _make_handle_error_listener(state: W2P01PluginState):
...
def register_handle_error_listener(engine, state: W2P01PluginState) -> None:
...
def remove_handle_error_listener(engine, state: W2P01PluginState) -> None:
...
def verify_sqlalchemy_version_minimum() -> None:
    ...
    try:
        ...
        major = 0
    if major < 2:
        raise W2P01HarnessError(BLOCKED_DEPENDENCY_RESOLUTION)
...
def resolve_runner_temp_dir(repo_root: Optional[Path] = None) -> Path:
    ...
    target = (Path(tempfile.gettempdir()) / "sedi_w2p01_postgres_runtime_evidence").resolve()
    target.mkdir(parents=True, exist_ok=True)
    if _path_is_inside(target, repo_root):
        raise W2P01HarnessError("FAIL_UNAUTHORIZED_REPOSITORY_MUTATION evidence path in repo")
    return target
...
def assert_evidence_path_outside_repository(path: Path, repo_root: Optional[Path] = None) -> None:
    ...
    if _path_is_inside(path.resolve(), repo_root.resolve()):
        raise W2P01HarnessError("FAIL_UNAUTHORIZED_REPOSITORY_MUTATION")
...
def capture_redacted_evidence(evidence: W2P01GitHubPostgresEvidence) -> dict[str, Any]:
    return {
        "mode": evidence.mode,
...
def initialize_evidence_context(state: W2P01PluginState, *, mode: str) -> None:
    ev = state.evidence
    ev.mode = mode
...
def configure_environment_from_urls(state: W2P01PluginState) -> str:
    ...
    state.evidence.selector_count = len(W2P01_RUNTIME_SELECTORS)
    return test_url


def runtime_bootstrap_after_manifest(state: W2P01PluginState) -> None:
    ...
    verify_w2p01_schema_tables(engine, W2P01_EXPECTED_SCHEMA_TABLES)
    state.evidence.schema_tables = [t for t in tables if t in W2P01_EXPECTED_SCHEMA_TABLES]
