"""W4-P01 GitHub PostgreSQL knowledge retrieval runtime pytest plugin."""
...
STATE_ATTR = "_w4p01_plugin_state"
...
def pytest_sessionfinish(session: pytest.Session, exitstatus: int) -> None:
    ...
    try:
        ...
        out = evidence_dir / (
            "w4p01_collect_only_evidence.json"
            if state.collect_only_mode
            else "w4p01_runtime_evidence.json"
        )
