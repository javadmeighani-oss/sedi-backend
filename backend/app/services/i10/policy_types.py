...
class I10SemanticFamily(str, Enum):
    ...
    LAB_APPOINTMENT_REMINDER = "LAB_APPOINTMENT_REMINDER"
    MEDICAL_EVENT_REMINDER = "MEDICAL_EVENT_REMINDER"
    DAILY_WELLNESS_DIGEST = "DAILY_WELLNESS_DIGEST"
    GENERAL_CONTEXTUAL_FOLLOW_UP = "GENERAL_CONTEXTUAL_FOLLOW_UP"
    POST_EVENT_FOLLOW_UP = "POST_EVENT_FOLLOW_UP"
    LIFESTYLE_ROUTINE_COACHING = "LIFESTYLE_ROUTINE_COACHING"
    NUTRITION_PLAN_FOLLOW_UP = "NUTRITION_PLAN_FOLLOW_UP"
    EXERCISE_PLAN_FOLLOW_UP = "EXERCISE_PLAN_FOLLOW_UP"
