...
# ---------------------------------------------------------------------------
# I5-KNOW-03 — Studies / PICO / effects / recommendations
# ---------------------------------------------------------------------------
...
class StudyDesign(str, Enum):
    ...
    GUIDELINE_EVIDENCE_REVIEW = "GUIDELINE_EVIDENCE_REVIEW"
    REAL_WORLD_EVIDENCE = "REAL_WORLD_EVIDENCE"
    PRECLINICAL = "PRECLINICAL"
    OTHER = "OTHER"


class StudyArtifactRole(str, Enum):
...
class StudyInterventionRole(str, Enum):
...
class OutcomeCategory(str, Enum):
    ...
    ADVERSE_EVENT = "ADVERSE_EVENT"
    TREATMENT_DISCONTINUATION = "TREATMENT_DISCONTINUATION"
    PATIENT_REPORTED = "PATIENT_REPORTED"
    CAREGIVER_REPORTED = "CAREGIVER_REPORTED"
    OTHER = "OTHER"


class OutcomeDirectionOfBenefit(str, Enum):
...
class StudyOutcomeRole(str, Enum):
    PRIMARY = "PRIMARY"
    SECONDARY = "SECONDARY"
...
class StatisticalSignificanceLabel(str, Enum):
...
class ClinicalSignificanceLabel(str, Enum):
    IMPORTANT = "IMPORTANT"
...
class RecommendationDirection(str, Enum):
    ...
    CONDITIONAL = "CONDITIONAL"
    CONSIDER = "CONSIDER"
    RECOMMEND_AGAINST = "RECOMMEND_AGAINST"
...
class RecommendationEvidenceTargetKind(str, Enum):
    KNOWLEDGE_UNIT = "KNOWLEDGE_UNIT"
    ARTIFACT_VERSION = "ARTIFACT_VERSION"
    CLINICAL_STUDY = "CLINICAL_STUDY"
    SYSTEMATIC_REVIEW_ARTIFACT = "SYSTEMATIC_REVIEW_ARTIFACT"


class RiskOfBiasLabel(str, Enum):
    LOW = "LOW"
...
class TerminologyImportScope(str, Enum):
    METADATA_ONLY = "METADATA_ONLY"
    BOUNDED_FIXTURE = "BOUNDED_FIXTURE"
    API_CONTRACT = "API_CONTRACT"
    FULL_IMPORT_DEFERRED = "FULL_IMPORT_DEFERRED"
    PROHIBITED = "PROHIBITED"
